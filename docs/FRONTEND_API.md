...
| 角色 | 说明 | 前端可提供的主要操作 |
| --- | --- | --- |
| `RESIDENT` | 居民 | 欢迎首页、实时监控、3D 社区；右下角智能问答，全部只读 |
| `FIREFIGHTER` | 消防人员 | 欢迎首页、实时监控、3D 社区、通知记录、广播管理；右下角智能问答，可处置告警和下发广播 |
| `COMMUNITY_ADMIN` | 社区管理员 | 欢迎首页、实时监控、3D 社区、设备管理、通知记录、广播管理；右下角智能问答，可管理设备与地图位置 |
